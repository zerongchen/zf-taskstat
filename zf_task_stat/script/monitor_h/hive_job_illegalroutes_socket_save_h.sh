...
from_job_table=job_ubas_illegalroutes
to_job_socket_save=job_ud_monitor_illegalroutes_savedata_h
#非法路由检测分析
PACKETTYPE=1
PACKETSUBTYPE=129
...
hive -e " use ${DATABASE_SCHEMA};
        set mapred.job.name=job_illegalroutes_socket_save_${DATE}_${HOURS};
