...
#--------------------------------------------------
#非法路由月粒度表
from_job_ubas_illegalroutes_m=job_ubas_illegalroutes_m

echo `date +"%Y-%m-%d %H:%M:%S"`  "--------------------------------------"
echo `date +"%Y-%m-%d %H:%M:%S"`  "---- zf-statmange 2.10.1 --------------"
echo `date +"%Y-%m-%d %H:%M:%S"`  "Shell Version 2.10.1 update(2018-06-20)"
echo `date +"%Y-%m-%d %H:%M:%S"`  "--------------------------------------"
location_directory=tmp/zf_v2_ubas_illegalroutes_m_${SDATE}
...
,probe_type
,area_id
from ${from_job_ubas_illegalroutes_m} where dt='${SDATE}'
...
MYSQL_TABLE=zf_v2_ubas_illegalroutes_m
#---------------------------------------------------------------------------------------------------
