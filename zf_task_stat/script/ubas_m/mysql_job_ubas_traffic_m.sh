...
#--------------------------------------------------
#通用流量小时粒度表
from_job_ubas_traffic_m=job_ubas_traffic_m
...
OUTPUTPATH=/user/hive/warehouse/${hive_database}.db/${from_job_ubas_traffic_m}/${SDATE}
...
MYSQL_TABLE=zf_v2_ubas_traffic_m
