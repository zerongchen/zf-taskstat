...
#--------------------------------------------------
#通用流量小时粒度表
from_job_ubas_appflow_w=job_ubas_appflow_w
...
OUTPUTPATH=/user/hive/warehouse/${hive_database}.db/${from_job_ubas_appflow_w}/${SDATE}
...
MYSQL_TABLE=zf_v2_ubas_appflow_w
#---------------------------------------------------------------------------------------------------
